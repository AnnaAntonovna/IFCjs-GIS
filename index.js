...
mapboxgl.accessToken = 'pk.eyJ1IjoiYW5uYWJhcmFub3ZhIiwiYSI6ImNsamg4MXJydjBpaHgzaHA5OHF5NmJ5NXEifQ.TgRK8PUk8Z88OYipFvXKDg';
const map = new mapboxgl.Map({
  container: 'map',
  style: 'mapbox://styles/mapbox/light-v10',
  zoom: 20.5,
  center: [9.239699222539977, 45.46229790371362],
  pitch: 75,
  bearing: -80,
  antialias: true
});

const modelOrigin = [9.239699222539977, 45.46229790371362];
